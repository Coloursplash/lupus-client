...
import coloursplash.lupusclient.mixin.WorldRendererAccessor;
...
public class Outlines {
    ...
    public static void load() {
        try {
            ...
            outlinesShader = new ShaderEffect(mc.getTextureManager(), mc.getResourceManager(), mc.getFramebuffer(), new Identifier("lupus-client", "shaders/post/my_entity_outline.json"));
