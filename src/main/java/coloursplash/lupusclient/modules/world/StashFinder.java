...
package coloursplash.lupusclient.modules.world;
...
import coloursplash.lupusclient.gui.screens.StashFinderChunkScreen;
...
public class StashFinder extends Module {
    ...
    public StashFinder() {
        super(Categories.World, "stash-finder", "Searches loaded chunks for storage blocks. Saves to <your minecraft folder>/lupus-client");
    }
    ...
    private File getJsonFile() {
        return new File(new File(new File(LupusClient.FOLDER, "stashes"), Utils.getWorldName()), "stashes.json");
    }

    private File getCsvFile() {
        return new File(new File(new File(LupusClient.FOLDER, "stashes"), Utils.getWorldName()), "stashes.csv");
    }
