...
import coloursplash.lupusclient.events.entity.DropItemsEvent;
...
import coloursplash.lupusclient.events.entity.player.PlaceBlockEvent;
...
public class Announcer extends Module {
    ...
    public void onActivate() {
        for (Feature feature : features) {
            if (feature.isEnabled()) {
                LupusClient.EVENT_BUS.subscribe(feature);
                feature.reset();
            }
        }
    }
    ...
    public void onDeactivate() {
        for (Feature feature : features) {
            if (feature.isEnabled()) {
                LupusClient.EVENT_BUS.unsubscribe(feature);
            }
        }
    }
