...
package coloursplash.lupusclient.modules.movement.elytrafly;
...
import coloursplash.lupusclient.modules.movement.elytrafly.modes.Packet;
import coloursplash.lupusclient.modules.movement.elytrafly.modes.Vanilla;
...
public class ElytraFly extends Module {
    ...
    protected void enableGroundListener() {
        LupusClient.EVENT_BUS.subscribe(staticListener);
    }

    protected void disableGroundListener() {
        LupusClient.EVENT_BUS.unsubscribe(staticListener);
    }
}