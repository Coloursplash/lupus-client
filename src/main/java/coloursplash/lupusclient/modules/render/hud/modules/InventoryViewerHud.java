...
public class InventoryViewerHud extends HudElement {
    ...
    private static final Identifier TEXTURE_LIGHT = new Identifier("lupus-client", "container_3x9.png");
    private static final Identifier TEXTURE_LIGHT_TRANSPARENT = new Identifier("lupus-client", "container_3x9-transparent.png");
    private static final Identifier TEXTURE_DARK = new Identifier("lupus-client", "container_3x9-dark.png");
    private static final Identifier TEXTURE_DARK_TRANSPARENT = new Identifier("lupus-client", "container_3x9-dark-transparent.png");
